...
#-------------------------------------------------------------------------------
# Name:        PZ-90
# Purpose: PZ-90測地系に関するパラメータと機能を提供する
#
# Author:      morishita
#
# Created:     02/03/2014
...
# Licence:     MIT
# History:     2014/3/2     WGS84を基に作成
#-------------------------------------------------------------------------------
import math

# 各種パラメータ
a = 6378136.0                                    				# 赤道半径[m]
InversOblateness = 298.257839303                                # 扁平率の逆数
...
GM = 3.9860044e14                                               # 地球重力定数[m^3/s^2] 
J2 = 1082625.75e-9                                              # Second zonal harmonic coefficient
