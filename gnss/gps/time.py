...
#               2014/2/10   timeKMモジュールから必要な部分を分離させた。
#                           get_DayOfWeek_From_DelimitedDate()のバグを修正
#               2014/2/12   うるう秒を求めるconvert_utc2leap_time()，GPS時刻を返すconvert_utc2gpst()，GPS週番号を返すconvert_utc2gpsw()を追加
#                           うるう秒を求める処理は以下のリンク先を参考にしている。
#                           http://fenrir.naruoka.org/download/autopilot/common/ruby/gpstime.rb
#               2014/2/26   GPS時刻を返すconvert_utc2gpst()に1秒未満の補正項を入れた。
#-------------------------------------------------------------------------------
import re
import decimal
import datetime
